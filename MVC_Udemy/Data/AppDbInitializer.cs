                    ...
                    context.Cinemas.AddRange(new List<Cinema>()
                        {
                            new Cinema()
                            {
                                ...
                                Description = "This is a descriptions of a first cinema"
                            },
                            new Cinema()
                            {
                                Name = "Cinema 2",
                                Logo = "https://dotnethow.net/images/cinemas/cinema-2.jpeg",
                                Description = "This is a descriptions of a secord cinema"
                            },
                            new Cinema()
                            {
                                Name = "Cinema 3",
                                Logo = "https://dotnethow.net/images/cinemas/cinema-3.jpeg",
                                Description = "This is a descriptions of a third cinema"
                            }
                            ,new Cinema()
                            {
                                Name = "Cinema 4",
                                Logo = "https://dotnethow.net/images/cinemas/cinema-4.jpeg",
                                Description = "This is a descriptions of a four cinema"
                            }
                            ,new Cinema()
                            {
                                Name = "Cinema 5",
                                Logo = "https://dotnethow.net/images/cinemas/cinema-5.jpeg",
                                Description = "This is a descriptions of a fifth cinema"
                            }
                        });
                    context.SaveChanges();
                }
